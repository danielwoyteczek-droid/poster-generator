...
'split-halves': {
  ...
  'hearts-diagonal': {
    ...
    shape: {
      ...
      bottomFraction: 0.6,
      // hearts-diagonal calibration: 1.15/1.18/1.13 all clipped the
      // left half. Daniel and I settled on 1.08 + 0.04 offset as the
      // safe value — a touch more presence than uniform-fit without
      // touching the canvas edges.
      landscapeScale: 1.08,

...
export const MAP_MASKS: Record<MapMaskKey, MapMaskDefinition> = {
  ...
  'split-halves': {
    ...
    shape: {
      ...
      markup: '<rect x="8.5" y="8.5" width="286.32" height="824.9" rx="2.835"/><rect x="300.49" y="8.5" width="286.32" height="824.9" rx="2.835"/>',
      bottomFraction: 0.99,
      shapeLandscape: {
        viewBox: '0 0 841.9 595.3',
        width: 841.9,
        height: 595.3,
        markup: '<rect x="8.5" y="8.5" width="409.62" height="578.3" rx="2.835"/><rect x="423.79" y="8.5" width="409.62" height="578.3" rx="2.835"/>',
        bottomFraction: 1,
      },
    },
  },
  ...
  'hearts-diagonal': {
    ...
    shape: {
      ...
      shapeLandscape: {
        ...
        width: 841.9,
        height: 595.3,
        markup: '<g transform="translate(169 25) scale(1.4)"><path d="M136.3,61.11c1.5-5.53,9.76-33.85,38.57-50.14,37.18-21.02,80.27-7.67,100.29,29.57,15.66,29.14,7.57,57.08,6,62.14-15.22-18.91-39.57-27.47-62.14-21.86-22.02,5.48-37.95,23.6-43.18,45.33-6.1,25.34,4.7,46.41,14.46,69.09,3.84,8.93,9.56,22.47,16.29,39.43-6,13.29-12,26.57-18,39.86-35.95-24.11-72.04-48.01-108.26-71.72-27.96-18.3-60.6-33.17-73.46-66.28C.02,118.9-1.21,98.73,5.18,80.79,26.1,22.02,95.54,27.45,136.3,61.11Z"/><path d="M291.01,133.68c3.17-1.95,37.47-22.36,67.14-6.57,4.64,2.47,10.77,6.67,16.57,14,3.49,4.8,11.45,17.16,11.43,34.29-.01,10.3-2.91,19.15-6.78,26.37-6.29,11.72-16.35,20.97-28.33,26.73l-119.46,57.47-46-110.86c-2.77-5.15-11.25-22.53-6.86-44.57.32-1.6.69-3.16,1.11-4.65,5.23-18.81,19.37-34.07,37.95-40.06,6.49-2.09,14.05-3.26,22.35-2.3,24.4,2.84,45.26,22.97,50.87,50.15Z"/></g>',
        splitMarkup: {
          left: '<g transform="translate(169 25) scale(1.4)"><path d="M136.3,61.11c1.5-5.53,9.76-33.85,38.57-50.14,37.18-21.02,80.27-7.67,100.29,29.57,15.66,29.14,7.57,57.08,6,62.14-15.22-18.91-39.57-27.47-62.14-21.86-22.02,5.48-37.95,23.6-43.18,45.33-6.1,25.34,4.7,46.41,14.46,69.09,3.84,8.93,9.56,22.47,16.29,39.43-6,13.29-12,26.57-18,39.86-35.95-24.11-72.04-48.01-108.26-71.72-27.96-18.3-60.6-33.17-73.46-66.28C.02,118.9-1.21,98.73,5.18,80.79,26.1,22.02,95.54,27.45,136.3,61.11Z"/></g>',
          right: '<g transform="translate(169 25) scale(1.4)"><path d="M291.01,133.68c3.17-1.95,37.47-22.36,67.14-6.57,4.64,2.47,10.77,6.67,16.57,14,3.49,4.8,11.45,17.16,11.43,34.29-.01,10.3-2.91,19.15-6.78,26.37-6.29,11.72-16.35,20.97-28.33,26.73l-119.46,57.47-46-110.86c-2.77-5.15-11.25-22.53-6.86-44.57.32-1.6.69-3.16,1.11-4.65,5.23-18.81,19.37-34.07,37.95-40.06,6.49-2.09,14.05-3.26,22.35-2.3,24.4,2.84,45.26,22.97,50.87,50.15Z"/></g>',
        },

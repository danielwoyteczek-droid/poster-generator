...
'split-halves': {
  ...
  'hearts-curved': {
    ...
    shape: {
      viewBox: '0 0 595.3 841.9',
      width: 595.3, height: 841.9,
      markup: '<g transform="translate(40 48) scale(0.9)"><path d="M211.2,224.38c3.12-53.45-41.67-104.88-97.22-95.13l-.18.03c-80.21,15.67-90.26,95.71-56.78,158.97,20.87,40.7,58.58,71.89,98.42,93.38,8.37,4.38,16.92,8.54,25.68,12.34,5.81,2.2,11.43,5.94,16.73,4.48,5.06-2.1-10.63-25.09-11.01-31.22-25.8-63,20.33-85.35,24.35-142.85Z"/><path d="M364.1,183.38c-19.67-61.75-106.26-75.91-142.8-21.78-14.78,19.83,8.86,49.29.87,76.4-5.3,29.47-26.69,52.38-30.88,82.28-4.25,19.24,7.08,66.16,22.81,77.65l.14.07c19.1,6.07,50.24-22.98,66.44-33.72,50.73-42.97,103.78-110.65,83.42-180.9Z"/></g>',
      bottomFraction: 0.55,
    },
  },
  'hearts-diagonal': {

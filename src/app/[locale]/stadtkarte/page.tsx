...
/**
 * `/stadtkarte/` — DE-Locale-Hub für Stadt-Karten-LPs (PROJ-44).
 * Koexistiert mit `/stadtkarte/[slug]/page.tsx` aus PROJ-42.
 */
export default async function StadtkarteHubPage({ params }: PageProps) {

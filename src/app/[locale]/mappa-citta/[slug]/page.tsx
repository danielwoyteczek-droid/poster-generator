...
const SEGMENT = 'mappa-citta' as const
...
/**
 * `/mappa-citta/[slug]` — IT-Locale-Route fuer Stadt-Landing-Pages (PROJ-42).
 */
export default async function MappaCittaPage({ params, searchParams }: PageProps) {
